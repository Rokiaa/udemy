...
echo 'If you need support, please, copy and paste the info below in our &nbsp;
...
?>
		<textarea style="height:100vh"; readonly="readonly" onclick="this.focus(); this.select()"><?php echo wptools_sysinfo_get(); ?></textarea>
<?php
}
...
function wptools_sysinfo_get() {
	...
	if( !class_exists( 'Browser' ) )
		require_once WPTOOLSPATH . 'functions/browser.php';
