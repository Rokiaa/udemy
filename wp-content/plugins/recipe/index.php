...
//  Hooks
register_activation_hook(__FILE__, 'r_activate_plugin'); // this function will be called when the plugin is activated
add_action('init', 'recipe_init');
add_action('save_post_recipe', 'r_save_post_admin', 10, 3);
// this function works exactly the same as the add action function
