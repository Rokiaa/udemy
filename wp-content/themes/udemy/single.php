                    ...
                    <div id="post-<?php the_ID(); ?>" <?php post_class('single-post nobottommargin'); ?>>
                        ...
                        <div class="entry-content notopmargin">
                            ...
                            <div class="tagcloud clearfix bottommargin">
                                <?php the_tags('', ' ');  //the first parameter will display text before the tag the second will be the seperator  ?>
                            </div><!-- .tagcloud end -->
                        ...
                        <div class="card-body">
                           ...
                           <?php echo nl2br(get_the_author_meta('description')); // nl2br -->will convert new line to BR html tags ?>
                        </div>
                        ...
                        <div class="related-posts clearfix">
                            ...
                            // print_r($categories);
                                //create instance of a query class
                                // posts_per_page how many posts per page 
                                // post__not_in key to define what posts should be returned
                                // cat --> define if the posts should be in a specific category
                                ...
                                if($rp_query->have_posts()){
                                    ...
                                    // this is the most important part when creating the secondry loops ut not calling this function
                                    // using loop multiple time make sure to reset it
                                    wp_reset_postdata();
                                }
                             ?>
